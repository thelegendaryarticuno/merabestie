...
const AdminLogin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Admin Login | Urban Edge</title>
      </Helmet>
      <Navbar />
      <div className="h-[calc(100vh-140px)] bg-gray-900 flex items-center justify-center p-4 mt-20">
        <motion.div
        ...
        >
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-red-500 mt-2">Log in to Admin Dashboard</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              {!selectedMethod ? (
                <div className="flex justify-center gap-8">
                  <button
                    ...
                    className="flex flex-col items-center p-4 px-8 border-2 border-gray-700 rounded-xl hover:border-red-500 transition-colors"
                  >
                    <Mail size={36} className="text-red-500 mb-2" />
                  ...
                  <button
                    ...
                    className="flex flex-col items-center p-4 px-8 border-2 border-gray-700 rounded-xl hover:border-red-500 transition-colors"
                  >
                    <Phone size={36} className="text-red-500 mb-2" />
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength="10"
                    pattern="[0-9]{10}"
                    className="w-full pl-20 pr-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-300"
                    value={emailOrPhone}
                    onChange={(e) => {
              ...
              <motion.button
                type="button"
                className="w-full bg-red-600 hover:bg-red-700 text-white py-3 rounded-lg font-semibold transition duration-300 transform active:scale-95"
                whileTap={{ scale: 0.95 }}
                onClick={handleLogin}
              >
                Login
